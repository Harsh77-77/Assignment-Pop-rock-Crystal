  ...
  return (
    <div className="w-[90%] h-full flex flex-col md:flex-row justify-center items-center gap-0 relative mx-auto">
      <div className="text-center md:text-right h-full flex items-center xl:items-end justify-center flex-col w-full z-10">
        ...
        <div className="text-[48px] md:text-[64px] font-bold leading-[48px] md:leading-[65px] text-[#31546D] mb-4">
          Agate Phone Grip
        </div>
        ...
        <div className="text-[14px] md:text-[16px] font-normal leading-[20px] md:leading-[24px] text-[#31546D] w-full md:w-[400px] mb-6">
      ...
      <div className="w-full h-full xl:flex justify-center md:justify-end items-center relative z-0 mt-8 md:mt-0 hidden">
        <div className="flex justify-center items-center w-[744px] h-[744px] bg-[rgba(255,255,255,0.2)] rounded-full ">
