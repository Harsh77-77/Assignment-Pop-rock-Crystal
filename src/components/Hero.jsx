...
const Hero = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-start w-screen h-screen px-4">
      <div className="flex flex-col md:flex-row justify-between items-center w-full lg:w-[90%]">
        ...
        <div className="hidden xl:flex flex-col justify-center items-end w-full">
          <div className="xl:w-[500px] xl:h-[500px] 2xl:w-[569px] 2xl:h-[554px] flex justify-center items-center bg-white rounded-[50px] shadow-custom overflow-hidden relative">
